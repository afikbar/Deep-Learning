...
def main():
    questions = os.path.join(config.qa_path, 'v2_OpenEnded_mscoco_train2014_questions.json')
    answers = os.path.join(config.qa_path, 'v2_mscoco_train2014_annotations.json')
