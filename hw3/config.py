...
preprocessed_trainval_path = 'data/preprocessed/genome-trainval.h5'  # path where preprocessed features from the trainval split are saved to and loaded from
preprocessed_test_path = 'data/preprocessed/genome-test.h5'  # path where preprocessed features from the test split are saved to and loaded from
vocabulary_path = 'data/vocab.json'  # path where the used vocabularies for question and answers are saved to
...
batch_size = 256
initial_lr = 1e-3
# initial_lr = 1.5e-3 # for "Learning to count objects"
lr_decay_step = 2
lr_decay_rate = 0.25
